...
export default class BranchPitStop extends LightningElement {
    ...
    navigateToTask(event) {
        ...
        if (parentTabId) {
            ...
            openSubtab(this, {
                ...
                console.error('BranchPitStop - error opening subtab:', error);
            });
        } else {
            // Experience Cloud or standard nav – navigate to the record URL
