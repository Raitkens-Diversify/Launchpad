...
import markWelcomeSeen from '@salesforce/apex/NexSWelcomeController.markWelcomeSeen';
 ...
 */
export default class NexsWelcomeVideo extends LightningElement {
    @track saveError;
    ...
    handleContinue() {
        ...
        markWelcomeSeen().catch((e) => {
            ...
            console.error('nexsWelcomeVideo markWelcomeSeen failed', e);
        });
