...
import getEngagement from '@salesforce/apex/ArcArticleEngagementController.getEngagement';
import castVote from '@salesforce/apex/ArcArticleEngagementController.castVote';
import submitFeedback from '@salesforce/apex/ArcArticleEngagementController.submitFeedback';

// Server-side mirror: ArcArticleEngagementController.MAX_COMMENT — change both together.
 ...
 *
 * Composed only inside arcArticleViewer (not exposed). Imperative Apex (not
 ...
 */
export default class ArcArticleRating extends LightningElement {
    ...
    async handleSubmitComment() {
        const field = this.template.querySelector('.arc-rating__textarea');
    ...
    get upClass() {
        return this.voteType === 'Up'
            ? 'arc-rating__thumb arc-rating__thumb--active'
            : 'arc-rating__thumb';
    }
