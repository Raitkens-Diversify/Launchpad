trigger Registration_Trigger on Registration__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
	Registration_TriggerHandler handler = new Registration_TriggerHandler();
	if (Trigger.isBefore) {
		 if (Trigger.isInsert) {
