trigger Finserv_ContactContact_Trigger on FinServ__ContactContactRelation__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
	FinServ_ContactContact_TriggerHandler handler = new FinServ_ContactContact_TriggerHandler();
	if (Trigger.isBefore) {
		 if (Trigger.isInsert) {
