({
    ...
    init : function(component, event, helper) {
        ...
        var flowInterviewId = component.get("v.flowInterviewId");
        ...
        if(objectFields != null && component.get("v.flowInterviewId") != null)
        {
    ...
    deleteRecord : function(component, helper, index){
        var flowInterviewFieldName = component.get("v.flowInterviewFieldName");
        var flowInterviewId = component.get("v.flowInterviewId");
        ...
        action.setParams(
            { 
                "objType" : sObjectVal,
                "flowInterviewId" :  flowInterviewId,
                "parentLookup" : flowInterviewFieldName,
                "recordId": recordId
            }
        );
        action.setCallback(this, function(actionResult) {
    ...
    updateRecord : function(component, event, record, index)
    {
        ...
        /*if(flowInterviewFieldName != null && flowInterviewId != null){
            record[flowInterviewFieldName] = flowInterviewId;
        }*/
    ...
    {
        var action = component.get("c.getExistingRecordsForFARPs");
        var recordType = component.get("v.recordTypeName");
        var disable = false;
        
        var wFAIds = (component.get("v.wFAIds") !='' && component.get("v.wFAIds") !=null)? component.get("v.wFAIds").trim().split(',') : null;
        
        recordType = recordType!=null && recordType.length>0 ? recordType : null; 
        action.setParams(
            {     
                flowInterviewId : component.get("v.flowInterviewId"),
                wFAIds : wFAIds,
                wFAFieldName : component.get("v.wFAFieldName"),
                objType:component.get("v.sObjectName"),
                flowInterviewFieldName:component.get("v.flowInterviewFieldName"),
    ...
    handleTotalAmount : function(component, event, helper){
        ...
        action.setParams({"sObjectName": objectName, "parentFieldName" : flowInterviewFieldName, "parentFieldId" : flowInterviewId,
