({
    ...
    init : function(component, event, helper) {
        ...
        var lstSObjectFieldsnew=objectFields.split(',');
       ...
       // component.set("v.tableHeaderRecords" ,lstSObjectFields);
        ...
        action.setParams({ sObjectName : component.get("v.sObjectName") ,
                          sObjectFields : lstSObjectFieldsnew});
    ...
    createfinAccOpp:function(component,event,helper){
        var oppId=component.get("v.OpportunityId");
        var finaccIds=component.get("v.FinServFinancialAccountIDs");
        var action=component.get("c.createfinaccOpp");
        action.setParams({oppId:oppId,finAccIds:finaccIds});
        action.setCallback(this,function(response){
            ...
            if(status==='SUCCESS'){
                ...
                this.showToastEvent('Error', 'Error', "Error" + response.getError()[0].message);
            }
        });
        $A.enqueueAction(action);
    }
